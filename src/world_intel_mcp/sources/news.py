...
_RSS_FEEDS: dict[str, list[tuple[str, str]]] = {
    ...
    "think_tanks": [
        ("RAND", "https://www.rand.org/pubs/commentary.xml"),
        ("Brookings", "https://www.brookings.edu/feed/"),
        ("Carnegie", "https://carnegieendowment.org/feed"),
    ...
    "arctic": [
        ("The Barents Observer", "https://thebarentsobserver.com/en/rss"),
        ("Arctic Today", "https://www.arctictoday.com/feed/"),
        ("High North News", "https://www.highnorthnews.com/en/rss"),
    ],
    "maritime": [
    ...
    "nuclear": [
        ...
        ("Arms Control Assn", "https://www.armscontrol.org/rss.xml"),
